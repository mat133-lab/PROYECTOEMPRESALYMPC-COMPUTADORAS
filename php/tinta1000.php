...
<body>
    ...
    <div class="container" style="margin-top: 100px;">
       ...
       <div class="row" id="product-container">
            ...
            <?php else: ?>
            <div class="col-12">
                <div class="alert alert-info text-center">No hay productos disponibles en la categoría Tintas de 1000 ML en este momento.</div>
            </div>
            <?php endif; ?>
        </div>
    </div>
