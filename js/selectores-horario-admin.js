...
export const modal = document.querySelector('#modal-calendar');
export const modalHeading = document.querySelector('#modal-heading');
export const modalCalendarList = document.querySelector('#modal-calendar-list');
