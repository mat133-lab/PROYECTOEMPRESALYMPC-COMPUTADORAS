...
$asistenteName = isset($_SESSION['asistente_name']) ? htmlspecialchars($_SESSION['asistente_name']) : 'Asistente';
$asistenteEmail = $_SESSION['correo'] ?? 'Correo no proporcionado';
$asistenteType = $_SESSION['rol'] ?? 'No especificado';
$asistenteCedula = $_SESSION['cedula'] ?? 'No proporcionada';

// Buscar los archivos en la base de datos usando el ID del usuario
$asistenteId = null;

if (!empty($_SESSION['id_usuario'])) {
    $asistenteId = $_SESSION['id_usuario'];
} elseif (!empty($_SESSION['id'])) {
    $asistenteId = $_SESSION['id'];
}

$asistenteCopia = $_SESSION['archivo_cedula'] ?? '';
$asistenteRuc = $_SESSION['archivo_ruc'] ?? '';
...
if ($asistenteId) {
    ...
    $stmt->execute([$asistenteId]);
    $archivos = $stmt->fetch(PDO::FETCH_ASSOC);

    if ($archivos) {
        $asistenteCopia = $archivos['archivo_cedula'] ?? $asistenteCopia;
        $asistenteRuc = $archivos['archivo_ruc'] ?? $asistenteRuc;
        $asistenteFoto = $archivos['foto_perfil'] ?? '';
    }
}
?>
<!doctype html>
...
<body>
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav flex-grow-1 pe-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?php if (isset($_SESSION['asistente_name'])): ?>
                            <span class="text-white me-3">Buen dia,
                                <b><?php echo $_SESSION['asistente_name']; ?></b></span>
                            <a href="/php/logout.php" class="btn btn-danger btn-sm">Cerrar Sesión</a>
                            <?php else: ?>
                            <a href="/php/login.php" class="btn btn-light btn-sm me-2">Iniciar Sesión</a>
                            <a href="/php/register.php" class="btn btn-outline-light btn-sm">Registrarse</a>
    ...
    <div class="main-content container mt-5 pt-4">
        ...
        <div class="dashboard-header text-left">
            ...
            <h1 class="title"><?php echo $asistenteName ?>🧑‍💼</h1>
            <label class="switch">
                    ...
                    <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                        ...
                        <div class="card card-custom position-relative text-center overflow-hidden">
                            ...
                            <div class="foto-placeholder shadow-sm"
                                ...
                                <?php if(!empty($asistenteFoto)): ?>
                                <img src="/storage/uploads/profile/<?php echo $asistenteFoto; ?>" alt="Foto de Perfil"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-6 field-group">
                                    ...
                                    <div class="field-value text-muted fw-normal mt-2" style="font-size: 0.95rem;">
                                        <?php if ($asistenteCopia || $asistenteRuc !== 'NULL'): ?>
                                        <div class="d-flex flex-column gap-2">
                                            <?php if ($asistenteCopia && $asistenteCopia !== 'NULL'): ?>
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="<?php echo htmlspecialchars($asistenteCopia); ?>" target="_blank"
                                                    class="btn btn-sm btn-outline-primary"
                                                    style="padding: 0.2rem 0.6rem; font-size: 0.8rem;">
                                                    <i class="fas fa-eye me-1"></i> Ver Cédula
                                                </a>
                                                <a href="<?php echo htmlspecialchars($asistenteCopia); ?>" download
                                            ...
                                            <?php endif; ?>
                                            <?php if ($asistenteRuc && $asistenteRuc !== 'NULL'): ?>
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="<?php echo htmlspecialchars($asistenteRuc); ?>" target="_blank"
                                                    class="btn btn-sm btn-outline-success"
                                                    style="padding: 0.2rem 0.6rem; font-size: 0.8rem;">
                                                    <i class="fas fa-eye me-1"></i> Ver RUC
                                                </a>
                                                <a href="<?php echo htmlspecialchars($asistenteRuc); ?>" download
    ...
    <footer class="footer">
        <div class="container footer-content">
            <div>
                ...
                <p style="max-width:320px; color:#bbb;">Perfil asistente - Derechos Reservados</p>
            </div>
        </div>
    </footer>
