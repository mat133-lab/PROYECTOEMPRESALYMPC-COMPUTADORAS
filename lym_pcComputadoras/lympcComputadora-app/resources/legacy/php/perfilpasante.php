...
$UsuName = isset($_SESSION['usuario']) ? htmlspecialchars($_SESSION['usuario']) : 'Pasante';
...
<head>
    ...
    <link rel="stylesheet" href="/css/perfilpasante.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>

<body data-login-time="<?php echo $login_timestamp; ?>">
                    ...
                    <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                        ...
                        <div class="card card-custom position-relative text-center overflow-hidden">
                            ...
                            <div class="foto-placeholder shadow-sm"
                                ...
                                <img src="/storage/uploads/profile/<?php echo $UsuFoto; ?>" alt="Foto de Perfil"
    ...
    <script src="/js/perfilpasante.js"></script>
